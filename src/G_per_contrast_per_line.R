G_per_contrast_per_line <- function(df_contrast, Data,
                                    correction = "williams")
{
  ...
  G_values_as_list <- lapply(Lines, function(line)
  {
    ...
    {
      G_value <- GTest(Data[[line]][contrast[1],], 
                       Data[[line]][contrast[2],],
                       correct = correction)
